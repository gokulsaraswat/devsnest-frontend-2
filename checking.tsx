...
function Chapter({ task, updateAllTasks }: Props) {
  ...
  return (
    <>
      <Grid container>
        <Grid item md={4} style={{ padding: '10px', backgroundColor: 'pink' }}>
        ...
        <Grid item sm={4}>
          <Button className={classes.buttonTop} style={{backgroundColor:'#F1A615' }}>Explore</Button>
        </Grid>
              ...
              >
                <Grid item xl={6} md={8} sm={8} xs={12}>
                  <Progress style={{ backgroundColor: '#F1A615' }} value={30} />
                </Grid>
